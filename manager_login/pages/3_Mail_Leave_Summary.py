...
with form:
    ...
    #msg = EmailMessage()
    body = "Dear HR, <br>Kindly find the attached leave summary for the month of September 2023 for SOT.<br><br>Note: This is an auto generated message.<br><br>Thank You."
    msg = MIMEMultipart()
    ...
    if file is not None:
        newfilename = file.name[:-4] + str(int(time())) +".xlsx"
